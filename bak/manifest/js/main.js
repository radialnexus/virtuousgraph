...
// Import ManifestGraph.vue component
import ManifestGraph from './views/ManifestGraph.vue';
// Import TubeGraph.vue component
import TubeGraph from './views/TubeGraph.vue';
...
const router = createRouter({
  ...
  routes: [
	...
	// BEGIN insert route
    { path: '/manifest', component: ManifestGraph },
    { path: '/tube', component: TubeGraph },
	// END insert route
